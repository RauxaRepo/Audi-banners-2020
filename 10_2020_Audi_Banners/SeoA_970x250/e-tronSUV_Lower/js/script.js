var manifest = [
        ...
        },
        {
            ...
            "type": "text",
            "default": "Gift yourself excitement."
        },
        {
            "name": "F1_headlineTxt_size_hex_xy",
            "type": "text",
            "default": "21.5|#FFF|607,105"
        },
        {
            "name": "F2_headline_txt",
            "type": "text",
            "default": "Cross it off your wishlist."
        },
        {
            "name": "F2_headlineTxt_size_hex_xy",
            "type": "text",
            "default": "21.5|#FFF|32,105"
        },
        {
            "name": "F3_headline_txt",
            "type": "text",
            "default": "The season is here<br>for special offers on<br>select Audi models."
        },
        {
            "name": "F3_local_txt",
            "type": "text",
        ...
        },
        {
            ...
            "type": "text",
            "default": "21.5|#FFF|44,83"
        },
        {
            "name": "F3_localTxt_size_hex_xy",
            "type": "text",
            "default": "10|#fff|660,222"
        },
        {
            "name": "cta_txt",
            "type": "text",
            "default": "Bring home an Audi e-tron SUV >"
        },
        {
            "name": "ctaTxt_size_hex_face_lineheight_spacing_xy",
            "type": "text",
            "default": "11|#FFF|'audi-extendedbold'|auto|auto|43,163"
        },
        {
        ...
        },
        {
            "name": "F4_carMake_txt",
            "type": "text",
            "default": "Be sure to use appropriate all-season or winter tires and always drive in a manner appropriate for the conditions."
        },
        {
            "name": "F4_carMakeTxt_size_hex_face_lineheight_spacing_xy",
            "type": "text",
            "default": "7.3|#fff|6,237"
        },
        {
        ...
        },
        {
            "name": "background_img",
            "type": "image",
            "default": "images/Audi_SeoAetronSUV_Lower_F1_970x250.jpg"
        },
        {
            "name": "logo_img",
            "type": "image",
            "default": "images/logo_nonOffer_970x250_x2.png"
        },
        {
            "name": "promoLogo_img",
            "type": "image",
            "default": "images/promoLogo_nonOffer_970x250_x2.png"
        },
        {
            "name": "carIMG",
            "type": "image",
            "default": "images/Audi_SeoAetronSUV_Lower_F2_970x250.jpg"
        },
        {
            "name": "carShimmerIMG",
            "type": "image",
            "default": "images/Audi_SeoAetronSUV_Lower_F3_970x250.jpg"
        }
];
...
//        F3_headline_txt.classList.add("headlines-centered");
        ...
        imageArray.push([sprite, "images/spritesheet_970x250.png"]);
...
function startAnimation() {
    ...
    tl.fromTo(sprite, 3, {
        ...
        backgroundPosition: "-62080px 0px",
        ease: "steps(64)",
    }, 'transition1-=2.5');
