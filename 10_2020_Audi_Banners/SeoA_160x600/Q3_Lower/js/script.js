var manifest = [
        {
            ...
            "type": "text",
            "default": "2020_Audi_T2_ACR_ROT_Intent_Chicago_2020_Q3_Generic"
        },
        {
            "name": "URL_type_txt",
            "type": "text",
            "default": "global-incentives"
        },
        {
            "name": "carMake_txt",
            "type": "text",
        ...
        },
        {
            ...
            "type": "text",
            "default": "Gift yourself<br>excitement."
        },
        {
            "name": "F1_headlineTxt_size_hex_xy",
            "type": "text",
            "default": "15.5|#FFF|20,390"
        },
        {
            "name": "F2_headline_txt",
            "type": "text",
            "default": "Cross it off<br>your wishlist."
        },
        {
            "name": "F2_headlineTxt_size_hex_xy",
            "type": "text",
            "default": "15.5|#FFF|18,132"
        },
        {
            "name": "F3_headline_txt",
            "type": "text",
            "default": "The season<br>is here for<br>special offers<br>on select<br>Audi models."
        },
        {
            "name": "F3_local_txt",
            "type": "text",
            "default": "Local copy<br>30 character count."
        },
        {
            "name": "F3_headlineTxt_size_hex_xy",
            "type": "text",
            "default": "15.5|#FFF|14,133"
        },
        {
        ...
        },
        {
            "name": "cta_txt",
            "type": "text",
            "default": "<div style='text-align:left'>Bring home<br>an Audi Q3 ></div>"
        },
        {
            "name": "ctaTxt_size_hex_face_lineheight_spacing_xy",
            "type": "text",
            "default": "11|#FFF|'audi-extendedbold'|auto|auto|40,390"
        },
        {
        ...
        },
        {
            "name": "F4_carMake_txt",
            "type": "text",
            "default": "Be sure to use appropriate all-season or<br>winter tires and always drive in a manner<br>appropriate for the conditions."
        },
        {
            "name": "F4_carMakeTxt_size_hex_face_lineheight_spacing_xy",
            "type": "text",
            "default": "7.3|#fff|10,567"
        },
        {
        ...
        },
        {
            "name": "background_img",
            "type": "image",
            "default": "images/Audi_SeoAQ3_Lower_F1_160x600.jpg"
        },
        {
            "name": "logo_img",
            "type": "image",
            "default": "images/logo_nonOffer_160x600_x2.png"
        },
        {
            "name": "promoLogo_img",
            "type": "image",
            "default": "images/promoLogo_nonOffer_160x600_x2.png"
        },
        {
            "name": "carIMG",
            "type": "image",
            "default": "images/Audi_SeoAQ3_Lower_F2_160x600.jpg"
        },
        {
            "name": "carShimmerIMG",
            "type": "image",
            "default": "images/Audi_SeoAQ3_Lower_F3_160x600.jpg"
        },
        {
            "name": "richload_main",
            "type": "richLoad",
            "default": "Static_Blank_rl/index.html"
        },
        {
            "name": "richload_bkgdAnime",
            "type": "richLoad",
            "default": "2020_Audi_T2_SeoA_160x600_RL/index.html"
        }
];
...
function setInstantAds() {
    try {
        ...
        imageArray.push([sprite, "images/spritesheet_160x600.png"]);
...
function startAnimation() {
    ...
    tl.fromTo(sprite, 3, {
        ...
        backgroundPosition: "-10240px 0px",
        ease: "steps(64)",
    }, 'transition1-=2.5');
