...
function initializeUnit() {
    ...
    rebuildHeadline("<span style='font-size:1em;line-height:1em'>Plug into</span>|<span style='font-size:1em;line-height:1em'>tomorrow.</span>");
...
function animateFrameTwo(){
    ...
    if(!disclaimerClick){
        ...
        TweenMax.to(inner, .63, {x:-364, ease:Power3.easeInOut, rotate:.01,
            ...
            rebuildHeadline("<span style='font-size:1em;line-height:1em'>Drive</span>|<span style='font-size:1em;line-height:1em'>it today.</span>");
...
function resizeHeadline(){
    var a = "<span style='font-size:1em;line-height:1em'>Plug into</span>|<span style='font-size:1em;line-height:1em'>tomorrow.</span>";
    var b = "<span style='font-size:1em;line-height:1em'>Drive</span>|<span style='font-size:1em;line-height:1em'>it today.</span>";
    if(a.indexOf("|") != -1){
        var a_text = a.split("|");
