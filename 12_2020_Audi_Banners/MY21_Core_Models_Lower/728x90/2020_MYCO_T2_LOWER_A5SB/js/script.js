...
function preloadImage(f) {
    ...
    a = [
        "2021_AudiA5SB_Lower_F1_728x90.jpg",
        z
    ];
...
function initializeUnit() {
    ...
    outer_backgroundOne.src = "2021_AudiA5SB_Lower_F1_728x90.jpg";
    outer_backgroundTwo.src = "2021_AudiA5SB_Lower_F2_728x90.jpg";
        logo_img.src = "./images/rings-lockup.png";

    

    rebuildHeadline("Reject the|ordinary.");
...
function animateFrameTwo(){
    ...
    if(!disclaimerClick){
        ...
        TweenMax.to(inner, .63, {x:-364, ease:Power3.easeInOut, rotate:.01,
            ...
            outer_backgroundOne.src = "2021_AudiA5SB_Lower_F3_728x90.jpg";
            secondFrame = true;

            rebuildHeadline("Embrace|the thrill.");
...
function resizeHeadline(){
    var a = "Reject the|ordinary.";
    var b = "Embrace|the thrill.";
    if(a.indexOf("|") != -1){
        var a_text = a.split("|");
