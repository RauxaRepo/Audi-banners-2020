...
function preloadImage(f) {
    ...
    a = [
        "2020_AudiQ7_Lower_F1_728x90.jpg",
        z
    ];
...
function initializeUnit() {
    ...
    outer_backgroundTwo.src = "2020_AudiQ7_Lower_F2_728x90.jpg";
...
function animateFrameTwo(){
    ...
    if(!disclaimerClick){
        ...
        TweenMax.to(inner, .63, {x:-364, ease:Power3.easeInOut, rotate:.01,
            ...
            outer_backgroundOne.src = "2020_AudiQ7_Lower_F3_728x90.jpg";
            secondFrame = true;
