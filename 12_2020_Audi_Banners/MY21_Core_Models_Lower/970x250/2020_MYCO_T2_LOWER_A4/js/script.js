...
function preloadImage(f) {
    ...
    a = [
        "2020_AudiA4_Lower_F1_970x250.jpg",
        z
    ];
...
function initializeUnit() {
    ...
    outer_backgroundOne.src = "2020_AudiA4_Lower_F1_970x250.jpg";
    outer_backgroundTwo.src = "2020_AudiA4_Lower_F2_970x250.jpg";
    logo_img.src = "./images/rings-lockup_9x2.png";


    rebuildHeadline("<span style='font-size:.8em;line-height:.8em'>Rethink what's</span>|<span style='font-size:.8em;line-height:.8em'>possible.</span>");
...
function animateFrameTwo(){
    ...
    TweenMax.to(inner, .63, {x:-485, ease:Power3.easeInOut, rotate:.01,
            ...
            outer_backgroundOne.src = "2021_AudiA4_Lower_F3_970x250.jpg";
            secondFrame = true;

            rebuildHeadline("<span style='font-size:.8em;line-height:.8em'>Challenge</span>|<span style='font-size:.8em;line-height:.8em'>the road.</span>");
...
function resizeHeadline(){
    var a = "<span style='font-size:.8em;line-height:.8em'>Rethink what's</span>|<span style='font-size:.8em;line-height:.8em'>possible.</span>";
    var b = "<span style='font-size:.8em;line-height:.8em'>Challenge</span>|<span style='font-size:.8em;line-height:.8em'>the road.</span>";
    if(a.indexOf("|") != -1){
        var a_text = a.split("|");
