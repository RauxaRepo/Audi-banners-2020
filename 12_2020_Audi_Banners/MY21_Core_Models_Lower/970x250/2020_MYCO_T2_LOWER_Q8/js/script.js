...
function preloadImage(f) {
    ...
    a = [
        "2020_AudiQ8_Lower_F1_970x250.jpg",
        z
    ];
...
function initializeUnit() {
    ...
    outer_backgroundTwo.src = "2020_AudiQ8_Lower_F2_970x250.jpg";
...
function animateFrameTwo(){
    ...
    TweenMax.to(inner, .63, {x:-485, ease:Power3.easeInOut, rotate:.01,
            ...
            outer_backgroundOne.src = "2021_AudiQ8_Lower_F3_970x250.jpg";
            secondFrame = true;

            rebuildHeadline("<span style='font-size:.8em;line-height:.8em'>Pursue</span>|<span style='font-size:.8em;line-height:.8em'>adventure.</span>");
...
function resizeHeadline(){
    var a = "<span style='font-size:.8em;line-height:.8em'>Stop</span>|<span style='font-size:.8em;line-height:.8em'>waiting.</span>";
    var b = "<span style='font-size:.8em;line-height:.8em'>Pursue</span>|<span style='font-size:.8em;line-height:.8em'>adventure.</span>";
    if(a.indexOf("|") != -1){
        var a_text = a.split("|");
