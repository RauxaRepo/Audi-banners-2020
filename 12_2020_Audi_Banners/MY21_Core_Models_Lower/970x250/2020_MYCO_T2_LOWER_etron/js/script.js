...
function initializeUnit() {
    ...
    rebuildHeadline("<span style='font-size:.8em;line-height:.8em'>Plug into</span>|<span style='font-size:.8em;line-height:.8em'>tomorrow.</span>");
...
function animateFrameTwo(){
    ...
    TweenMax.to(inner, .63, {x:-485, ease:Power3.easeInOut, rotate:.01,
            ...
            rebuildHeadline("<span style='font-size:.8em;line-height:.8em'>Drive</span>|<span style='font-size:.8em;line-height:.8em'>it today.</span>");
...
function resizeHeadline(){
    var a = "<span style='font-size:.8em;line-height:.8em'>Plug into</span>|<span style='font-size:.8em;line-height:.8em'>tomorrow.</span>";
    var b = "<span style='font-size:.8em;line-height:.8em'>Drive</span>|<span style='font-size:.8em;line-height:.8em'>it today.</span>";
    if(a.indexOf("|") != -1){
        var a_text = a.split("|");
