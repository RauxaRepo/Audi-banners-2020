...
function preloadImage(f) {
    ...
    a = [
        "2020_AudiQ7_Lower_F1_160x600.jpg",
        z
    ];
...
function initializeUnit() {
    ...
    outer_backgroundOne.src = "2020_AudiQ7_Lower_F1_160x600.jpg"
    outer_backgroundTwo.src = "2020_AudiQ7_Lower_F2_160x600.jpg"

    logo_img.src = "./images/rings-lockup.png";

    

    rebuildHeadline("<span style='font-size: 130%'>Follow your</span>|<span style='font-size: 130%'>instinct.</span>");
...
function animateFrameTwo(){
    ...
    if(!disclaimerClick){
        ...
        TweenMax.to(inner, .63, {y:-300, ease:Power3.easeInOut, rotate:.01,
            ...
            outer_backgroundOne.src = "2020_AudiQ7_Lower_F3_160x600.jpg";
            secondFrame = true;

            rebuildHeadline("<span style='font-size: 130%'>Make it</span>|<span style='font-size: 130%'>yours.</span>");
...
function resizeHeadline(){
    var a = "<span style='font-size: 130%'>Follow your</span>|<span style='font-size: 130%'>instinct.</span>";
    var b = "<span style='font-size: 130%'>Make it</span>|<span style='font-size: 130%'>yours.</span>";
    if(a.indexOf("|") != -1){
        var a_text = a.split("|");
