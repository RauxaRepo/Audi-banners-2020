...
function preloadImage(f) {
    ...
    a = [
        "2020_AudiQ3_Lower_F1_160x600.jpg",
        z
    ];
...
function initializeUnit() {
    ...
    outer_backgroundOne.src = "2020_AudiQ3_Lower_F1_160x600.jpg"
    outer_backgroundTwo.src = "2021_AudiQ3_Lower_F2_160x600.jpg"

    logo_img.src = "./images/rings-lockup.png";

    

    rebuildHeadline("<span style='font-size: 125%'>Tighten</span>|<span style='font-size: 125%'>your grip.</span>");
...
function animateFrameTwo(){
    ...
    if(!disclaimerClick){
        ...
        TweenMax.to(inner, .63, {y:-300, ease:Power3.easeInOut, rotate:.01,
            ...
            outer_backgroundOne.src = "2021_AudiQ3_Lower_F3_160x600.jpg";
            secondFrame = true;

            rebuildHeadline("<span style='font-size: 125%'>Bring</span>|<span style='font-size: 125%'>it home.</span>");
...
function resizeHeadline(){
    var a = "<span style='font-size: 125%'>Tighten</span>|<span style='font-size: 125%'>your grip.</span>";
    var b = "<span style='font-size: 125%'>Bring</span>|<span style='font-size: 125%'>it home.</span>";
    if(a.indexOf("|") != -1){
        var a_text = a.split("|");
