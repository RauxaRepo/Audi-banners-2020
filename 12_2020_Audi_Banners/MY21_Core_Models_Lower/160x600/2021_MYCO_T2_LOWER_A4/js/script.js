...
function preloadImage(f) {
    ...
    a = [
        "2020_AudiA4_Lower_F1_160x600.jpg",
        z
    ];
...
function initializeUnit() {
    ...
    outer_backgroundOne.src = "2020_AudiA4_Lower_F1_160x600.jpg"
    outer_backgroundTwo.src = "2020_AudiA4_Lower_F2_160x600.jpg"

    logo_img.src = "./images/rings-lockup.png";

    

    rebuildHeadline("<span style='font-size: 115%'>Rethink what's</span>|<span style='font-size: 115%'>possible.</span>");
...
function animateFrameTwo(){
    ...
    if(!disclaimerClick){
        ...
        TweenMax.to(inner, .63, {y:-300, ease:Power3.easeInOut, rotate:.01,
            ...
            outer_backgroundOne.src = "2021_AudiA4_Lower_F3_160x600.jpg";
            secondFrame = true;

            rebuildHeadline("<span style='font-size: 115%'>Challenge</span>|<span style='font-size: 115%'>the road.</span>");
...
function animateFrameThree(){
    setTimeout(function(){
        animateHeadline(function(){
            ...
            TweenMax.to(dag, .63,{y: -300, opacity: 1, rotate:.01, ease: Power3.easeInOut});
            TweenMax.to(inner, .63, {y:0, ease:Power3.easeInOut, rotate:.01,
              onComplete:function(){
...
function resizeHeadline(){
    var a = "<span style='font-size: 115%'>Rethink what's</span>|<span style='font-size: 115%'>possible.</span>";
    var b = "<span style='font-size: 115%'>Challenge</span>|<span style='font-size: 115%'>the road.</span>";
    if(a.indexOf("|") != -1){
        var a_text = a.split("|");
