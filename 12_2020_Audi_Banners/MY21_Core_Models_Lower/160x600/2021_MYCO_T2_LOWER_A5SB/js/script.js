...
function preloadImage(f) {
    ...
    a = [
        "2021_AudiA5SB_Lower_F1_160x600.jpg",
        z
    ];
...
function initializeUnit() {
    ...
    outer_backgroundOne.src = "2021_AudiA5SB_Lower_F1_160x600.jpg"
    outer_backgroundTwo.src = "2021_AudiA5SB_Lower_F2_160x600.jpg"

    logo_img.src = "./images/rings-lockup.png";

    

    rebuildHeadline("<span style='font-size: 130%'>Reject the</span>|<span style='font-size: 130%'>ordinary.</span>");
    
    
    // if ("".split("|")[1] != "") s.innerHTML += "#inner .headline-endText { color: " + "".split("|")[1] + "; }\n\n";

    var logo_lockup = "<div style='text-align:left;margin-left:-2px;'>Audi<br>A5 Sportback</div>";
...
function animateFrameTwo(){
    ...
    if(!disclaimerClick){
        ...
        TweenMax.to(inner, .63, {y:-300, ease:Power3.easeInOut, rotate:.01,
            ...
            outer_backgroundOne.src = "2021_AudiA5SB_Lower_F3_160x600.jpg";
            secondFrame = true;

            rebuildHeadline("<span style='font-size: 130%'>Embrace</span>|<span style='font-size: 130%'>the thrill.</span>");
...
function animateFrameThree(){
    setTimeout(function(){
        animateHeadline(function(){
            ...
            TweenMax.to(dag, .63,{top: -300, opacity: 1, rotate:.01, ease: Power3.easeInOut}); 
...
function resizeHeadline(){
    var a = "<span style='font-size: 130%'>Reject the</span>|<span style='font-size: 130%'>ordinary.</span>";
    var b = "<span style='font-size: 130%'>Embrace</span>|<span style='font-size: 130%'>the thrill.</span>";
    if(a.indexOf("|") != -1){
        var a_text = a.split("|");
