...
function preloadImage(f) {
    ...
    a = [
        "2020_AudiA4_Lower_F1_300x600.jpg",
        z
    ];
...
function initializeUnit() {
    ...
    outer_backgroundOne.src = "2020_AudiA4_Lower_F1_300x600.jpg"
    outer_backgroundTwo.src = "2020_AudiA4_Lower_F2_300x600.jpg"
        logo_img.src = "./images/rings-lockup.png";
    

    rebuildHeadline("<span style='font-size:1.1em;line-height:1.1em'>Rethink what's</span>|<span style='font-size:1.1em;line-height:1.1em'>possible.</span>");
...
function animateFrameTwo(){
    ...
    if(!disclaimerClick){
        ...
        TweenMax.to(inner, .63, {y:-300, ease:Power3.easeInOut, rotate:.01,
            ...
            outer_backgroundOne.src = "2021_AudiA4_Lower_F3_300x600.jpg";
            secondFrame = true;


            rebuildHeadline("<span style='font-size:1.1em;line-height:1.1em'>Challenge</span>|<span style='font-size:1.1em;line-height:1.1em'>the road.</span>");
...
function resizeHeadline(){
    var a = "<span style='font-size:1.1em;line-height:1.1em'>Rethink what's</span>|<span style='font-size:1.1em;line-height:1.1em'>possible.</span>";
    var b = "<span style='font-size:1.1em;line-height:1.1em'>Challenge</span>|<span style='font-size:1.1em;line-height:1.1em'>the road.</span>";
    if(a.indexOf("|") != -1){
        var a_text = a.split("|");
