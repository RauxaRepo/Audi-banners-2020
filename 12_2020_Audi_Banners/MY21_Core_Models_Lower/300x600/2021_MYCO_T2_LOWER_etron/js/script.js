...
function initializeUnit() {
    ...
    rebuildHeadline("<span style='font-size:..9em;line-height:.9em'>Plug into</span>|<span style='font-size:..9em;line-height:.9em'>tomorrow.</span>");
...
function animateFrameTwo(){
    ...
    if(!disclaimerClick){
        ...
        TweenMax.to(inner, .63, {y:-300, ease:Power3.easeInOut, rotate:.01,
            ...
            rebuildHeadline("<span style='font-size:..9em;line-height:.9em'>Drive</span>|<span style='font-size:..9em;line-height:.9em'>it today.</span>");
...
function resizeHeadline(){
    var a = "<span style='font-size:..9em;line-height:.9em'>Plug into</span>|<span style='font-size:..9em;line-height:.9em'>tomorrow.</span>";
    var b = "<span style='font-size:..9em;line-height:.9em'>Drive</span>|<span style='font-size:..9em;line-height:.9em'>it today.</span>";
    if(a.indexOf("|") != -1){
        var a_text = a.split("|");
