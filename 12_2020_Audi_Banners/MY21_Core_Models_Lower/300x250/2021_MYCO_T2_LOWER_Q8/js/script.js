...
function preloadImage(f) {
    ...
    a = [
        "2020_AudiQ8_Lower_F1_300x250.jpg",
        z
    ];
...
function initializeUnit() {
    ...
    outer_backgroundOne.src = "2020_AudiQ8_Lower_F1_300x250.jpg"
    outer_backgroundTwo.src = "2020_AudiQ8_Lower_F2_300x250.jpg"
        logo_img.src = "./images/rings-lockup.png";
    

    rebuildHeadline("Stop|waiting.");
...
function animateFrameTwo(){
    ...
    TweenMax.to(inner, .63, {y:-125, ease:Power3.easeInOut, rotate:.01,
            ...
            outer_backgroundOne.src = "2020_AudiQ8_Lower_F3_300x250.jpg";
            secondFrame = true;

            rebuildHeadline("Pursue|adventure.");
