...
function preloadImage(f) {
    ...
    a = [
        "2021_Audietron_Lower_F1_300x250.jpg",
        z
    ];
...
function initializeUnit() {
    ...
    outer_backgroundOne.src = "2021_Audietron_Lower_F1_300x250.jpg"
    outer_backgroundTwo.src = "2021_Audietron_Lower_F2_300x250.jpg"
        logo_img.src = "./images/rings-lockup.png";
    

    rebuildHeadline("<span style='font-size:1em;line-height:.75em'>Plug into</span>|<span style='font-size:1em;line-height:.75em'>tomorrow.</span>");
...
function animateFrameTwo(){
    ...
    TweenMax.to(inner, .63, {y:-125, ease:Power3.easeInOut, rotate:.01,
            ...
            outer_backgroundOne.src = "2021_Audietron_Lower_F3_300x250.jpg";
            secondFrame = true;

            rebuildHeadline("<span style='font-size:1em;line-height:.75em'>Drive</span>|<span style='font-size:1em;line-height:.75em'>it today.</span>|");
...
function animateFrameThree(){
    setTimeout(function(){
        animateHeadline(function(){
            ...
            TweenMax.to(dag, .63,{top: -125, rotate:.01, ease: Power3.easeInOut});  
...
function resizeHeadline(){
    var a = "<span style='font-size:1em;line-height:.75em'>Plug into</span>|<span style='font-size:1em;line-height:.75em'>tomorrow.</span>";
    var b = "<span style='font-size:1em;line-height:.75em'>Drive</span>|<span style='font-size:1em;line-height:.75em'>it today.</span>";
    if(a.indexOf("|") != -1){
        var a_text = a.split("|");
