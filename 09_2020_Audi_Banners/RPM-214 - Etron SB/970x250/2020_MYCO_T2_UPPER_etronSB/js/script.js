...
function preloadImage(f) {
    ...
    a = [
        "2021_AudietronSB_Upper_F1_970x250.jpg",
        z
    ];
...
function initializeUnit() {
    ...
    outer_backgroundOne.src = "2021_AudietronSB_Upper_F1_970x250.jpg";
    outer_backgroundTwo.src = "2021_AudietronSB_Upper_F2_970x250.jpg";
...
function animateFrameTwo(){
    ...
    TweenMax.to(inner, .63, {x:-485, ease:Power3.easeInOut, rotate:.01,
            ...
            outer_backgroundOne.src = "2021_AudietronSB_Upper_F3_970x250.jpg";
            secondFrame = true;
