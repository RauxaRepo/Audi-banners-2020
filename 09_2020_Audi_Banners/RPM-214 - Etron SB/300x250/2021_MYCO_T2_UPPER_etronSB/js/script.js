...
function preloadImage(f) {
    ...
    a = [
        "2021_AudietronSB_Upper_F1_300x250.jpg",
        z
    ];
...
function initializeUnit() {
    ...
    outer_backgroundOne.src = "2021_AudietronSB_Upper_F1_300x250.jpg"
    outer_backgroundTwo.src = "2021_AudietronSB_Upper_F2_300x250.jpg"
        logo_img.src = "./images/rings-lockup.png";
    

    rebuildHeadline("<span style='font-size:.9em'>Electric</span>|<span style='font-size:.9em'>elegance.</span>");
...
function animateFrameTwo(){
    ...
    TweenMax.to(inner, .63, {y:-125, ease:Power3.easeInOut, rotate:.01,
            ...
            outer_backgroundOne.src = "2021_AudietronSB_Upper_F3_300x250.jpg";
            secondFrame = true;

            rebuildHeadline("<span style='font-size:.9em'>Powerful</span>|<span style='font-size:.9em'>design.</span>");
...
function resizeHeadline(){
    var a = "<span style='font-size:.9em'>Electric</span>|<span style='font-size:.9em'>elegance.</span>";
    var b = "<span style='font-size:.9em'>Powerful</span>|<span style='font-size:.9em'>design.</span>";
    if(a.indexOf("|") != -1){
        var a_text = a.split("|");
