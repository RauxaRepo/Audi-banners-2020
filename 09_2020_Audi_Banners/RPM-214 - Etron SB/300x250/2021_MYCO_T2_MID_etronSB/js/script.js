...
function preloadImage(f) {
    ...
    a = [
        "2021_AudietronSB_Mid_F1_300x250.jpg",
        z
    ];
...
function initializeUnit() {
    ...
    outer_backgroundOne.src = "2021_AudietronSB_Mid_F1_300x250.jpg"
    outer_backgroundTwo.src = "2021_AudietronSB_Mid_F2_300x250.jpg"
        logo_img.src = "./images/rings-lockup.png";
    

    rebuildHeadline("<span style='font-size:.9em'>Electric quattro<sup>®</sup></span>|<span style='font-size:.9em'>all-wheel drive.</span>");
...
function animateFrameTwo(){
    ...
    TweenMax.to(inner, .63, {y:-125, ease:Power3.easeInOut, rotate:.01,
            ...
            outer_backgroundOne.src = "2021_AudietronSB_Mid_F3_300x250.jpg";
            secondFrame = true;

            rebuildHeadline("<span style='font-size:.9em'>Innovative road</span>|<span style='font-size:.9em'>performance.</span>");
...
function animateFrameThree(){
    setTimeout(function(){
        animateHeadline(function(){
            ...
            mLock.src = "etronSB_MY21_3x2.png";
            localCopy.src = "2021_AudietronSB_LC_300x250.png";
...
function resizeHeadline(){
    var a = "<span style='font-size:.9em'>Electric quattro<sup>®</sup></span>|<span style='font-size:.9em'>all-wheel drive.</span>";
    var b = "<span style='font-size:.9em'>Innovative road</span>|<span style='font-size:.9em'>performance.</span>";
    if(a.indexOf("|") != -1){
        var a_text = a.split("|");
...
function normalizeHeadline(f) {
    ...
    if(secondFrame){
        ...
        inner_headline.style.top = (125 - inner_headline.getBoundingClientRect().height)/2 + "px";
        if ("|#fff|".split("|")[2] != "") {
            inner_headline.style.left =  "|#fff|".split("|")[2].split(",")[0] + "px";
            inner_headline.style.top =  "|#fff|".split("|")[2].split(",")[1] + "px";
        }
