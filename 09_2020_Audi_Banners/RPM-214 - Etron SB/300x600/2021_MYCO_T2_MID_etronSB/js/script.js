...
function preloadImage(f) {
    ...
    a = [
        "2021_AudietronSB_Mid_F1_300x600.jpg",
        z
    ];
...
function initializeUnit() {
    ...
    outer_backgroundOne.src = "2021_AudietronSB_Mid_F1_300x600.jpg"
    outer_backgroundTwo.src = "2021_AudietronSB_Mid_F2_300x600.jpg"
    ...
    var logo_lockup = "<div style='text-align:left'>Audi<br><span style='font-size:88%'>e-tron<sup>®</sup> Sportback</span></div>";
...
function animateFrameTwo(){
    ...
    if(!disclaimerClick){
        ...
        TweenMax.to(inner, .63, {y:-300, ease:Power3.easeInOut, rotate:.01,
            ...
            outer_backgroundOne.src = "2021_AudietronSB_Mid_F3_300x600.jpg";
            secondFrame = true;


            rebuildHeadline("<span style='font-size:1em'>Innovative road</span>|<span style='font-size:1em'>performance.</span>");
...
function resizeHeadline(){
    ...
    var b = "<span style='font-size:1em'>Innovative road</span>|<span style='font-size:1em'>performance.</span>";
    if(a.indexOf("|") != -1){
        var a_text = a.split("|");
