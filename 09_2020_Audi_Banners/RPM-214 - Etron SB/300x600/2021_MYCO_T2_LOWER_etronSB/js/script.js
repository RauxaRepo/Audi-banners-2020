...
function preloadImage(f) {
    ...
    a = [
        "2021_AudietronSB_Lower_F1_300x600.jpg",
        z
    ];
...
function initializeUnit() {
    ...
    outer_backgroundTwo.src = "2021_AudietronSB_Lower_F2_300x600.jpg"
...
function animateFrameTwo(){
    ...
    if(!disclaimerClick){
        ...
        TweenMax.to(inner, .63, {y:-300, ease:Power3.easeInOut, rotate:.01,
            ...
            outer_backgroundOne.src = "2021_AudietronSB_Lower_F3_300x600.jpg";
            secondFrame = true;
