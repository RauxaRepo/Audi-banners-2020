...
function preloadImage(f) {
    ...
    a = [
        "2021_AudietronSB_Upper_F1_160x600.jpg",
        z
    ];
...
function initializeUnit() {
    ...
    outer_backgroundOne.src = "2021_AudietronSB_Upper_F1_160x600.jpg"
    outer_backgroundTwo.src = "2021_AudietronSB_Upper_F2_160x600.jpg"

    logo_img.src = "./images/rings-lockup.png";

    

    rebuildHeadline("Electric|elegance.");
...
function animateFrameTwo(){
    ...
    if(!disclaimerClick){
        ...
        TweenMax.to(inner, .63, {y:-300, ease:Power3.easeInOut, rotate:.01,
            ...
            outer_backgroundOne.src = "2021_AudietronSB_Upper_F3_160x600.jpg";
            secondFrame = true;

            rebuildHeadline("Powerful|design.");
...
function resizeHeadline(){
    var a = "Electric|elegance.";
    var b = "Powerful|design.";
    if(a.indexOf("|") != -1){
        var a_text = a.split("|");
