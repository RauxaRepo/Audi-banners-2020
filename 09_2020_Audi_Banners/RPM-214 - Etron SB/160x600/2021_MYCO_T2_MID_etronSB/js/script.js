...
function preloadImage(f) {
    ...
    a = [
        "2021_AudietronSB_Mid_F1_160x600.jpg",
        z
    ];
...
function initializeUnit() {
    ...
    outer_backgroundOne.src = "2021_AudietronSB_Mid_F1_160x600.jpg"
    outer_backgroundTwo.src = "2021_AudietronSB_Mid_F2_160x600.jpg"

    logo_img.src = "./images/rings-lockup.png";

    

    rebuildHeadline("Electric quattro<sup>®</sup>|all-wheel drive.");
    
    
    // if ("".split("|")[1] != "") s.innerHTML += "#inner .headline-endText { color: " + "".split("|")[1] + "; }\n\n";

    var logo_lockup = "<div style='text-align:left'>Audi<br><span style='font-size:89%'>e-tron<sup>®</sup> Sportback</span></div>";
...
function animateFrameTwo(){
    ...
    if(!disclaimerClick){
        ...
        TweenMax.to(inner, .63, {y:-300, ease:Power3.easeInOut, rotate:.01,
            ...
            outer_backgroundOne.src = "2021_AudietronSB_Mid_F3_160x600.jpg";
            secondFrame = true;

            rebuildHeadline("Innovative road|performance.");
...
function animateFrameThree(){
    setTimeout(function(){
        animateHeadline(function(){
            ...
            mLock.src = "etronSB_MY21_1x6.png";
            localCopy.src = "2021_AudietronSB_LC_160x600.png";
...
function resizeHeadline(){
    var a = "Electric quattro<sup>®</sup>|all-wheel drive.";
    var b = "Innovative road|performance.";
    if(a.indexOf("|") != -1){
        var a_text = a.split("|");
