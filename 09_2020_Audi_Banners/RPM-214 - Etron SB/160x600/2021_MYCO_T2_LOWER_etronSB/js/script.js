...
function preloadImage(f) {
    ...
    a = [
        "2021_AudietronSB_Lower_F1_160x600.jpg",
        z
    ];
...
function initializeUnit() {
    ...
    outer_backgroundOne.src = "2021_AudietronSB_Lower_F1_160x600.jpg"
    outer_backgroundTwo.src = "2021_AudietronSB_Lower_F2_160x600.jpg"

    logo_img.src = "./images/rings-lockup.png";

    

    rebuildHeadline("Dare to|be bold.");
...
function animateFrameTwo(){
    ...
    if(!disclaimerClick){
        ...
        TweenMax.to(inner, .63, {y:-300, ease:Power3.easeInOut, rotate:.01,
            ...
            outer_backgroundOne.src = "2021_AudietronSB_Lower_F3_160x600.jpg";
            secondFrame = true;

            rebuildHeadline("Charge|forward.");
...
function resizeHeadline(){
    var a = "Dare to|be bold.";
    var b = "Charge|forward.";
    if(a.indexOf("|") != -1){
        var a_text = a.split("|");
