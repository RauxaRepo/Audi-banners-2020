...
function preloadImage(f) {
    ...
    a = [
        "2021_AudietronSB_Mid_F1_728x90.jpg",
        z
    ];
...
function initializeUnit() {
    ...
    outer_backgroundOne.src = "2021_AudietronSB_Mid_F1_728x90.jpg";
    outer_backgroundTwo.src = "2021_AudietronSB_Mid_F2_728x90.jpg";
        logo_img.src = "./images/rings-lockup.png";

    

    rebuildHeadline("<span style='font-size:1em'>Electric quattro<sup>®</sup></span>|<span style='font-size:1em'>all-wheel drive.</span>");
    
    
    // if ("".split("|")[1] != "") s.innerHTML += "#inner .headline-endText { color: " + "".split("|")[1] + "; }\n\n";

    var logo_lockup = "<div style='text-align:left'>Audi<br><span style='font-size:87%'>e-tron<sup>®</sup> Sportback</span></div>";
...
function animateFrameTwo(){
    ...
    if(!disclaimerClick){
        ...
        TweenMax.to(inner, .63, {x:-364, ease:Power3.easeInOut, rotate:.01,
            ...
            outer_backgroundOne.src = "2021_AudietronSB_Mid_F3_728x90.jpg";
            secondFrame = true;

            rebuildHeadline("<span style='font-size:.85em;line-height:.6em'>Innovative road</span>|<span style='font-size:.85em;line-height:.6em'>performance.</span>");
...
function animateFrameThree(){
    setTimeout(function(){
        animateHeadline(function(){
            ...
            mLock.src = "etronSB_MY21_7x9.png";
...
function resizeHeadline(){
    var a = "<span style='font-size:1em'>Electric quattro<sup>®</sup></span>|<span style='font-size:1em'>all-wheel drive.</span>";
    var b = "<span style='font-size:.85em;line-height:.6em'>Innovative road</span>|<span style='font-size:.85em;line-height:.6em'>performance.</span>";
    if(a.indexOf("|") != -1){
        var a_text = a.split("|");
...
function normalizeHeadline(f) {
    ...
    if(secondFrame){
        ...
        if ("|#fff|95,26".split("|")[2] != "") {
            inner_headline.style.left =  "|#fff|95,26".split("|")[2].split(",")[0] + "px";
            inner_headline.style.top =  "|#fff|95,26".split("|")[2].split(",")[1] + "px";
        }
        if("|#fff|95,26".split("|")[1]!= ""){
            inner_headline.style.color = "|#fff|95,26".split("|")[1];
        }
        setTimeout(function(){
            animateHeadline(function(){
              animateFrameThree();  
