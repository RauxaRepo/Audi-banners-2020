...
function preloadImage(f) {
    ...
    a = [
        "2021_AudietronSB_Upper_F1_728x90.jpg",
        z
    ];
...
function initializeUnit() {
    ...
    outer_backgroundOne.src = "2021_AudietronSB_Upper_F1_728x90.jpg";
    outer_backgroundTwo.src = "2021_AudietronSB_Upper_F2_728x90.jpg";
        logo_img.src = "./images/rings-lockup.png";

    

    rebuildHeadline("<span style='font-size:1em'>Electric</span>|<span style='font-size:1em'>elegance.</span>");
...
function animateFrameTwo(){
    ...
    if(!disclaimerClick){
        ...
        TweenMax.to(inner, .63, {x:-364, ease:Power3.easeInOut, rotate:.01,
            ...
            outer_backgroundOne.src = "2021_AudietronSB_Upper_F3_728x90.jpg";
            secondFrame = true;

            rebuildHeadline("<span style='font-size:1em'>Powerful</span>|<span style='font-size:1em'>design.</span>");
...
function resizeHeadline(){
    var a = "<span style='font-size:1em'>Electric</span>|<span style='font-size:1em'>elegance.</span>";
    var b = "<span style='font-size:1em'>Powerful</span>|<span style='font-size:1em'>design.</span>";
    if(a.indexOf("|") != -1){
        var a_text = a.split("|");
...
function normalizeHeadline(f) {
    ...
    if(secondFrame){
        ...
        if ("|#fff|90,26".split("|")[2] != "") {
            inner_headline.style.left =  "|#fff|90,26".split("|")[2].split(",")[0] + "px";
            inner_headline.style.top =  "|#fff|90,26".split("|")[2].split(",")[1] + "px";
        }
        if("|#fff|90,26".split("|")[1]!= ""){
            inner_headline.style.color = "|#fff|90,26".split("|")[1];
        }
        setTimeout(function(){
            animateHeadline(function(){
              animateFrameThree();  
