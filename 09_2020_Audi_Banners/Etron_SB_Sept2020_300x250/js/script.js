...
function preloadImage(f) {
    ...
    a = [
        "2021_AudietronSB_Lower_F1_300x250.jpg",
        z
    ];
...
function initializeUnit() {
    ...
    outer_backgroundOne.src = "2021_AudietronSB_Lower_F1_300x250.jpg"
    outer_backgroundTwo.src = "2021_AudietronSB_Lower_F2_300x250.jpg"
...
function animateFrameTwo(){
    ...
    TweenMax.to(inner, .63, {y:-125, ease:Power3.easeInOut, rotate:.01,
            ...
            outer_backgroundOne.src = "2021_AudietronSB_Lower_F3_300x250.jpg";
            secondFrame = true;

            rebuildHeadline("<span style='font-size:.9em'>Charge</span>|<span style='font-size:.9em'>forward.</span>");
...
function resizeHeadline(){
    var a = "<span style='font-size:.9em'>Dare to</span>|<span style='font-size:.9em'>be bold.</span>";
    var b = "<span style='font-size:.9em'>Charge</span>|<span style='font-size:.9em'>forward.</span>";
    if(a.indexOf("|") != -1){
        var a_text = a.split("|");
