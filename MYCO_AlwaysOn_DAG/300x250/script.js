...
function preloadImage(f) {
    ...
    a = [
        "2021_AudiQ5PHEV_Low_F1_300x250.jpg",
        z
    ];
...
function initializeUnit() {
    ...
    outer_backgroundOne.src = "2021_AudiQ5PHEV_Low_F1_300x250.jpg"
    outer_backgroundTwo.src = "2021_AudiQ5PHEV_Low_F2_300x250.jpg"
        logo_img.src = "./images/rings-lockup.png";
    

    rebuildHeadline("Adaptable|hybrid tech.");
...
function animateFrameTwo(){
    ...
    TweenMax.to(inner, .63, {y:-125, ease:Power3.easeInOut, rotate:.01,
            ...
            outer_backgroundOne.src = "2021_AudiQ5PHEV_Low_F3_300x250.jpg";
            secondFrame = true;

            rebuildHeadline("Progressive|drive.");
...
function resizeHeadline(){
    var a = "Adaptable|hybrid tech.";
    var b = "Progressive|drive.";
    if(a.indexOf("|") != -1){
        var a_text = a.split("|");
