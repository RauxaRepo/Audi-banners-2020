...
function preloadImage(f) {
    ...
    a = [
        "2021_AudiQ5PHEV_Low_F1_970x250.jpg",
        z
    ];
...
function initializeUnit() {
    ...
    outer_backgroundOne.src = "2021_AudiQ5PHEV_Low_F1_970x250.jpg";
    outer_backgroundTwo.src = "2021_AudiQ5PHEV_Low_F2_970x250.jpg";
    logo_img.src = "./images/rings-lockup_9x2.png";


    rebuildHeadline("<span style='font-size:.85em;line-height:.85em'>Shift to</span>|<span style='font-size:.85em;line-height:.85em'>plug-in hybrid.</span>");
...
function animateFrameTwo(){
    ...
    TweenMax.to(inner, .63, {x:-485, ease:Power3.easeInOut, rotate:.01,
            ...
            outer_backgroundOne.src = "2021_AudiQ5PHEV_Low_F3_970x250.jpg";
            secondFrame = true;

            rebuildHeadline("<span style='font-size:.85em;line-height:.85em'>Bring home</span>|<span style='font-size:.85em;line-height:.85em'>progress.</span>");
...
function resizeHeadline(){
    var a = "<span style='font-size:.85em;line-height:.85em'>Shift to</span>|<span style='font-size:.85em;line-height:.85em'>plug-in hybrid.</span>";
    var b = "<span style='font-size:.85em;line-height:.85em'>Bring home</span>|<span style='font-size:.85em;line-height:.85em'>progress.</span>";
    if(a.indexOf("|") != -1){
        var a_text = a.split("|");
