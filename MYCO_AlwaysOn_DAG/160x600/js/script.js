...
function preloadImage(f) {
    ...
    a = [
        "2021_AudiQ5PHEV_Low_F1_160x600.jpg",
        z
    ];
...
function initializeUnit() {
    ...
    outer_backgroundOne.src = "2021_AudiQ5PHEV_Low_F1_160x600.jpg"
    outer_backgroundTwo.src = "2021_AudiQ5PHEV_Low_F2_160x600.jpg"

    logo_img.src = "./images/rings-lockup.png";

    

    rebuildHeadline("<span style='font-size:120%;line-height:1.1em'>Shift to</span>|<span style='font-size:120%;line-height:1.1em'>plug-in hybrid.</span>");
    ...
    dag.innerHTML = "DAG 30 character<br>count copy here.";
...
function animateFrameTwo(){
    ...
    if(!disclaimerClick){
        ...
        TweenMax.to(inner, .63, {y:-300, ease:Power3.easeInOut, rotate:.01,
            ...
            outer_backgroundOne.src = "2021_AudiQ5PHEV_Low_F3_160x600.jpg";
            secondFrame = true;

            rebuildHeadline("<span style='font-size:130%;line-height:1.2em'>Bring home</span>|<span style='font-size:130%;line-height:1.2em'>progress.</span>");
...
function resizeHeadline(){
    var a = "<span style='font-size:120%;line-height:1.1em'>Shift to</span>|<span style='font-size:120%;line-height:1.1em'>plug-in hybrid.</span>";
    var b = "<span style='font-size:130%;line-height:1.2em'>Bring home</span>|<span style='font-size:130%;line-height:1.2em'>progress.</span>";
    if(a.indexOf("|") != -1){
        var a_text = a.split("|");
