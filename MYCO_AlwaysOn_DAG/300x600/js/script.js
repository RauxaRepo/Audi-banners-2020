...
function preloadImage(f) {
    ...
    a = [
        "2021_AudiQ5PHEV_Low_F1_300x600.jpg",
        z
    ];
...
function initializeUnit() {
    ...
    outer_backgroundOne.src = "2021_AudiQ5PHEV_Low_F1_300x600.jpg"
    outer_backgroundTwo.src = "2021_AudiQ5PHEV_Low_F2_300x600.jpg"
        logo_img.src = "./images/rings-lockup.png";
    

    rebuildHeadline("Shift to|plug-in hybrid.");
...
function animateFrameTwo(){
    ...
    if(!disclaimerClick){
        ...
        TweenMax.to(inner, .63, {y:-300, ease:Power3.easeInOut, rotate:.01,
            ...
            outer_backgroundOne.src = "2021_AudiQ5PHEV_Low_F3_300x600.jpg";
            secondFrame = true;


            rebuildHeadline("Bring home|progress.");
...
function resizeHeadline(){
    var a = "Shift to|plug-in hybrid.";
    var b = "Bring home|progress.";
    if(a.indexOf("|") != -1){
        var a_text = a.split("|");
