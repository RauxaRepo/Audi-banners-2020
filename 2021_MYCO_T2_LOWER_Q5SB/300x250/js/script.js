...
function preloadImage(f) {
    ...
    a = [
        "2021_AudiQ5SB_Lower_F1_300x250.jpg",
        z
    ];
...
function initializeUnit() {
    ...
    outer_backgroundOne.src = "2021_AudiQ5SB_Lower_F1_300x250.jpg"
    outer_backgroundTwo.src = "2021_AudiQ5SB_Lower_F2_300x250.jpg"
        logo_img.src = "./images/rings-lockup.png";
    

    rebuildHeadline("<span style='font-size:.88em'>Ready to drive.</span>|");
...
function animateFrameTwo(){
    ...
    TweenMax.to(inner, .63, {y:-125, ease:Power3.easeInOut, rotate:.01,
            ...
            outer_backgroundOne.src = "2021_AudiQ5SB_Lower_F3_300x250.jpg";
            secondFrame = true;

            rebuildHeadline("<span style='font-size:.88em'>Take your seat.</span>|");
    ...
    inner_headline.addEventListener("transitionend", function f(e){
        ...
        if("" != "") {
            ...
            normalizeHeadline(thirdFrame);
                ...
                l.src = "allNew_Audi_MY21_3x2.png";
...
function resizeHeadline(){
    var a = "<span style='font-size:.88em'>Ready to drive.</span>|";
    var b = "<span style='font-size:.88em'>Take your seat.</span>|";
    if(a.indexOf("|") != -1){
        var a_text = a.split("|");
