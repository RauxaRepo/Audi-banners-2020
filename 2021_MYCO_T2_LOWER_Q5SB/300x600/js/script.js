...
function preloadImage(f) {
    ...
    a = [
        "2021_AudiQ5SB_Lower_F1_300x600.jpg",
        z
    ];
...
function initializeUnit() {
    ...
    outer_backgroundOne.src = "2021_AudiQ5SB_Lower_F1_300x600.jpg"
    outer_backgroundTwo.src = "2021_AudiQ5SB_Lower_F2_300x600.jpg"
        logo_img.src = "./images/rings-lockup.png";
    

    rebuildHeadline("<span style='font-size:.9em;line-height:.85em'>Ready to drive.</span>|");
...
function animateFrameTwo(){
    ...
    if(!disclaimerClick){
        ...
        TweenMax.to(inner, .63, {y:-300, ease:Power3.easeInOut, rotate:.01,
            ...
            outer_backgroundOne.src = "2021_AudiQ5SB_Lower_F3_300x600.jpg";
            secondFrame = true;


            rebuildHeadline("<span style='font-size:.9em;line-height:.85em'>Take your</span>|<span style='font-size:.9em;line-height:.85em'>seat.</span>");
    ...
    inner_headline.addEventListener("transitionend", function f(e){
        ...
        if("" != "") {
            ...
            var l = document.createElement("img");
                ...
                l.src = "allNew_Audi_MY21_3x6.png";
...
function resizeHeadline(){
    var a = "<span style='font-size:.9em;line-height:.85em'>Ready to drive.</span>|";
    var b = "<span style='font-size:.9em;line-height:.85em'>Take your</span>|<span style='font-size:.9em;line-height:.85em'>seat.</span>";
    if(a.indexOf("|") != -1){
        var a_text = a.split("|");
