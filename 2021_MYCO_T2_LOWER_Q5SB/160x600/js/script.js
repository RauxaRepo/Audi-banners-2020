...
function preloadImage(f) {
    ...
    a = [
        "2021_AudiQ5SB_Lower_F1_160x600.jpg",
        z
    ];
...
function initializeUnit() {
    ...
    clickTagHold.addEventListener('click', function() {
        window.open(clickTagURL, '_blank');
    });

    // Set IAs/Images for the first frame;
    outer_backgroundOne.src = "2021_AudiQ5SB_Lower_F1_160x600.jpg"
    outer_backgroundTwo.src = "2021_AudiQ5SB_Lower_F2_160x600.jpg"

    logo_img.src = "./images/rings-lockup.png";

    

    rebuildHeadline("<span style='font-size:1.2em;line-height:1.1em'>Ready</span>|<span style='font-size:1.2em;line-height:1.1em'>to drive.</span>");
    
    
    // if ("".split("|")[1] != "") s.innerHTML += "#inner .headline-endText { color: " + "".split("|")[1] + "; }\n\n";

    var logo_lockup = "<div style='text-align:left'>Audi<br>Q5 Sportback</div>";
...
function animateFrameTwo(){
    // inner_headline.style.transform = "matrix(1, 0, 0, 1, 0, 125) rotate(0.01deg)";
    // inner.style.transform = "matrix(1, 0, 0, 1, 0, -125) rotate(0.01deg)";
    ...
    if(!disclaimerClick){
        ...
        TweenMax.to(inner, .63, {y:-300, ease:Power3.easeInOut, rotate:.01,
            ...
            outer_backgroundOne.src = "2021_AudiQ5SB_Lower_F3_160x600.jpg";
            secondFrame = true;

            rebuildHeadline("<span style='font-size:1.2em;line-height:1.1em'>Take your</span>|<span style='font-size:1.2em;line-height:1.1em'>seat.</span>");
...
function animateFrameThree(){
    setTimeout(function(){
        animateHeadline(function(){
            ...
            mLock.src = "Q5SB_MY21_1x6.png";
            replay.addEventListener("click", resetAll);
            // mLock.classList.add("modelLockup");
            // main.appendChild(mLock);
            // logo.after(mLock);
            // logo_holder.main.insertBefore(mlock,logo_holder);
    ...
    inner_headline.addEventListener("transitionend", function f(e){
        ...
        if("" != "") {
            ...
            var l = document.createElement("img");
                ...
                l.src = "allNew_Audi_MY21_1x6.png";
...
function resizeHeadline(){
    var a = "<span style='font-size:1.2em;line-height:1.1em'>Ready</span>|<span style='font-size:1.2em;line-height:1.1em'>to drive.</span>";
    var b = "<span style='font-size:1.2em;line-height:1.1em'>Take your</span>|<span style='font-size:1.2em;line-height:1.1em'>seat.</span>";
    if(a.indexOf("|") != -1){
        var a_text = a.split("|");
