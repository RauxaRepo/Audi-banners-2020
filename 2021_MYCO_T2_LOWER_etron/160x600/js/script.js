...
function preloadImage(f) {
    ...
    a = [
        "2021_Audietron_Lower_F1_160x600.jpg",
        z
    ];
...
function initializeUnit() {
    ...
    outer_backgroundOne.src = "2021_Audietron_Lower_F1_160x600.jpg"
    outer_backgroundTwo.src = "2021_Audietron_Lower_F2_160x600.jpg"

    logo_img.src = "./images/rings-lockup.png";

    

    rebuildHeadline("Plug into|tomorrow.");
...
function animateFrameTwo(){
    ...
    if(!disclaimerClick){
        ...
        TweenMax.to(inner, .63, {y:-300, ease:Power3.easeInOut, rotate:.01,
            ...
            outer_backgroundOne.src = "2021_Audietron_Lower_F3_160x600.jpg";
            secondFrame = true;

            rebuildHeadline("<span style='font-size:1.18em;line-height:1.1em'>Drive</span>|<span style='font-size:1.18em;line-height:1.1em'>it today.</span>");
...
function animateFrameThree(){
    setTimeout(function(){
        animateHeadline(function(){
            ...
            mLock.src = "etron_MY21_1x6_v2.png";
...
function resizeHeadline(){
    var a = "<div style='font-size:96%'>Plug into</div>|<div style='font-size:96%'>tomorrow.</div>";
    var b = "<div style='font-size:96%'>Drive</div>|<div style='font-size:96%'>it today.</div>";
    if(a.indexOf("|") != -1){
        var a_text = a.split("|");
