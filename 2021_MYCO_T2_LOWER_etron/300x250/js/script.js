...
function initializeUnit() {
    ...
    rebuildHeadline("<div style='font-size:.88em;line-height:1.1em'>Plug into</div>|<div style='font-size:.88em;line-height:1.1em'>tomorrow.</div>");
...
function animateFrameTwo(){
    ...
    TweenMax.to(inner, .63, {y:-125, ease:Power3.easeInOut, rotate:.01,
            ...
            rebuildHeadline("<div style='font-size:.88em;line-height:1.1em'>Drive</span>|<div style='font-size:.88em;line-height:1.1em'>it today.</span>|");
...
function animateFrameThree(){
    setTimeout(function(){
        animateHeadline(function(){
            ...
            mLock.src = "etron_MY21_3x2_v2.png";
    ...
    inner_headline.addEventListener("transitionend", function f(e){
        ...
        if("" != "") {
            ...
            normalizeHeadline(thirdFrame);
                ...
                l.src = "Audi_MY21_2linesLRG_3x2.png";
...
function resizeHeadline(){
    var a = "<div style='font-size:.88em;line-height:1.1em'>Plug into</div>|<div style='font-size:.88em;line-height:1.1em'>tomorrow.</div>";
    var b = "<div style='font-size:.88em;line-height:1.1em'>Drive</span>|<div style='font-size:.88em;line-height:1.1em'>it today.</span>";
    if(a.indexOf("|") != -1){
        var a_text = a.split("|");
