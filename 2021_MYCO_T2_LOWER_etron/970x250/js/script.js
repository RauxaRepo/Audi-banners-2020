...
function preloadImage(f) {
    ...
    var s = document.createElement("style"),
        ...
        var z = "./images/rings-lockup_9x2.png";

    a = [
        "2021_Audietron_Lower_F1_970x250.jpg",
        z
    ];
...
function initializeUnit() {
    ...
    outer_backgroundOne.src = "2021_Audietron_Lower_F1_970x250.jpg";
    outer_backgroundTwo.src = "2021_Audietron_Lower_F2_970x250.jpg";
    logo_img.src = "./images/rings-lockup_9x2.png";


    rebuildHeadline("<div style='font-size:.69em;letter-spacing:-.01em;line-height:.98em'>Plug into</div>|<div style='font-size:.69em;letter-spacing:-.01em;line-height:.98em'>tomorrow.</div>");
...
function animateFrameTwo(){
    ...
    TweenMax.to(inner, .63, {x:-485, ease:Power3.easeInOut, rotate:.01,
            ...
            outer_backgroundOne.src = "2021_Audietron_Lower_F3_970x250.jpg";
            secondFrame = true;

            rebuildHeadline("<div style='font-size:.69em;letter-spacing:-.01em;line-height:.98em'>Drive</div>|<div style='font-size:.69em;letter-spacing:-.01em;line-height:.98em'>it today.</div>");
...
function animateFrameThree(){
    setTimeout(function(){
        animateHeadline(function(){
            ...
            mLock.src = "etron_MY21_9x2_v2.png";
    ...
    inner_headline.addEventListener("transitionend", function f(e){
        ...
        if("" != "") {
            ...
            var l = document.createElement("img");
                ...
                l.src = "Audi_MY21_2linesSM_9x2.png";
...
function resizeHeadline(){
    var a = "<div style='font-size:.69em;letter-spacing:-.01em;line-height:.98em'>Plug into</div>|<div style='font-size:.69em;letter-spacing:-.01em;line-height:.98em'>tomorrow.</div>";
    var b = "<div style='font-size:.69em;letter-spacing:-.01em;line-height:.98em'>Drive</div>|<div style='font-size:.69em;letter-spacing:-.01em;line-height:.98em'>it today.</div>";
    if(a.indexOf("|") != -1){
        var a_text = a.split("|");
