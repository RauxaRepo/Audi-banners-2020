...
function preloadImage(f) {
    ...
    a = [
        "2021_Audietron_Lower_F1_728x90.jpg",
        z
    ];
...
function initializeUnit() {
    ...
    outer_backgroundOne.src = "2021_Audietron_Lower_F1_728x90.jpg";
    outer_backgroundTwo.src = "2021_Audietron_Lower_F2_728x90.jpg";
        logo_img.src = "./images/rings-lockup.png";

    

    rebuildHeadline("<span style='font-size:1em;line-height:1.15em'>Plug into</span>|<span style='font-size:1em;line-height:1.15em'>tomorrow.</span>");
...
function animateFrameTwo(){
    ...
    if(!disclaimerClick){
        ...
        TweenMax.to(inner, .63, {x:-364, ease:Power3.easeInOut, rotate:.01,
            ...
            outer_backgroundOne.src = "2021_Audietron_Lower_F3_728x90.jpg";
            secondFrame = true;

            rebuildHeadline("<span style='font-size:1em;line-height:1.15em'>Drive it</span>|<span style='font-size:1em;line-height:1.15em'>today.</span>");
...
function animateFrameThree(){
    setTimeout(function(){
        animateHeadline(function(){
            ...
            mLock.src = "etron_MY21_7x9_v2.png";
    ...
    inner_headline.addEventListener("transitionend", function f(e){
        ...
        if("" != "") {
            ...
            var l = document.createElement("img");
                ...
                l.src = "Audi_MY21_1lineSM_7x9.png";
...
function resizeHeadline(){
    var a = "<span style='font-size:1em;line-height:1.15em'>Plug into</span>|<span style='font-size:1em;line-height:1.15em'>tomorrow.</span>";
    var b = "<span style='font-size:1em;line-height:1.15em'>Drive it</span>|<span style='font-size:1em;line-height:1.15em'>today.</span>";
    if(a.indexOf("|") != -1){
        var a_text = a.split("|");
