...
function preloadImage(f) {
    ...
    a = [
        "2021_Audietron_Lower_F1_300x600.jpg",
        z
    ];
...
function initializeUnit() {
    ...
    outer_backgroundOne.src = "2021_Audietron_Lower_F1_300x600.jpg"
    outer_backgroundTwo.src = "2021_Audietron_Lower_F2_300x600.jpg"
        logo_img.src = "./images/rings-lockup.png";
    

    rebuildHeadline("<span style='font-size:.9em;line-height:1.15em'>Plug into</span>|<span style='font-size:.9em;line-height:1.15em'>tomorrow.</span>");
...
function animateFrameTwo(){
    ...
    if(!disclaimerClick){
        ...
        TweenMax.to(inner, .63, {y:-300, ease:Power3.easeInOut, rotate:.01,
            ...
            outer_backgroundOne.src = "2021_Audietron_Lower_F3_300x600.jpg";
            secondFrame = true;


            rebuildHeadline("<span style='font-size:.9em;line-height:1.15em'>Drive</span>|<span style='font-size:.9em;line-height:1.15em'>it today.</span>");
...
function animateFrameThree(){
    setTimeout(function(){
        animateHeadline(function(){
            ...
            mLock.src = "etron_MY21_3x6_v2.png";
            ...
            TweenMax.to(inner, .63, {y:0, ease:Power3.easeInOut, rotate:.01, onComplete:function(){
                ...
                // slideElement(document.getElementsByClassName('modelLockup')[0]);
                cta.style.opacity = "1";
...
function resizeHeadline(){
    var a = "<span style='font-size:.9em;line-height:1.15em'>Plug into</span>|<span style='font-size:.9em;line-height:1.15em'>tomorrow.</span>";
    var b = "<span style='font-size:.9em;line-height:1.15em'>Drive</span>|<span style='font-size:.9em;line-height:1.15em'>it today.</span>";
    if(a.indexOf("|") != -1){
        var a_text = a.split("|");
