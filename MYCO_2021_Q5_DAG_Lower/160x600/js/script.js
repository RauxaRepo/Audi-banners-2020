...
function preloadImage(f) {
    ...
    a = [
        "2021_AudiQ5_Low_F1_160x600.jpg",
        z
    ];
...
function initializeUnit() {
    ...
    outer_backgroundOne.src = "2021_AudiQ5_Low_F1_160x600.jpg"
    outer_backgroundTwo.src = "2021_AudiQ5_Low_F2_160x600.jpg"

    logo_img.src = "./images/rings-lockup.png";

    

    rebuildHeadline("<span style='font-size:130%;line-height:1.2em'>Follow</span>|<span style='font-size:130%;line-height:1.2em'>your instinct.</span>");
    
    
    // if ("".split("|")[1] != "") s.innerHTML += "#inner .headline-endText { color: " + "".split("|")[1] + "; }\n\n";

    var logo_lockup = "Audi<br>Q5";
...
function animateFrameTwo(){
    ...
    if(!disclaimerClick){
        ...
        TweenMax.to(inner, .63, {y:-300, ease:Power3.easeInOut, rotate:.01,
            ...
            outer_backgroundOne.src = "2021_AudiQ5_Low_F3_160x600.jpg";
            secondFrame = true;

            rebuildHeadline("<span style='font-size:130%;line-height:1.2em'>Take on</span>|<span style='font-size:130%;line-height:1.2em'>the road.</span>");
...
function resizeHeadline(){
    var a = "<span style='font-size:130%;line-height:1.2em'>Follow</span>|<span style='font-size:130%;line-height:1.2em'>your instinct.</span>";
    var b = "<span style='font-size:130%;line-height:1.2em'>Take on</span>|<span style='font-size:130%;line-height:1.2em'>the road.</span>";
    if(a.indexOf("|") != -1){
        var a_text = a.split("|");
