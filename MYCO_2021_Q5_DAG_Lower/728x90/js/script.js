...
function initializeUnit() {
    ...
    outer_backgroundOne.src = "2021_AudiQ5_Low_F1_728x90.jpg";
    outer_backgroundTwo.src = "2021_AudiQ5_Low_F2_728x90.jpg";
        logo_img.src = "./images/rings-lockup.png";

    

    rebuildHeadline("<span style='font-size:1em;line-height:1em'>Follow</span>|<span style='font-size:1em;line-height:1em'>your instinct.</span>");
...
function animateFrameTwo(){
    ...
    if(!disclaimerClick){
        ...
        TweenMax.to(inner, .63, {x:-364, ease:Power3.easeInOut, rotate:.01,
            ...
            outer_backgroundOne.src = "2021_AudiQ5_Low_F3_728x90.jpg";
            secondFrame = true;

            rebuildHeadline("<span style='font-size:1em;line-height:1em'>Take on</span>|<span style='font-size:1em;line-height:1em'>the road.</span>");
...
function resizeHeadline(){
    var a = "<span style='font-size:1em;line-height:1em'>Follow</span>|<span style='font-size:1em;line-height:1em'>your instinct.</span>";
    var b = "<span style='font-size:1em;line-height:1em'>Take on</span>|<span style='font-size:1em;line-height:1em'>the road.</span>";
    if(a.indexOf("|") != -1){
        var a_text = a.split("|");
